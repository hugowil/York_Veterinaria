...
<asp:Content ID="Content6" ContentPlaceHolderID="ContentContenido" runat="server">
        ...
        <div class="card-body">
            ...
            <asp:GridView ID="GridView1" class="table table-striped table-bordered tableDatos" runat="server" AutoGenerateColumns="False" DataKeyNames="idTipoDocumento" DataSourceID="SqlDataSource1">
                <Columns>
